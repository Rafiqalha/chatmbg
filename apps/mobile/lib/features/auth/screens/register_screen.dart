              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: 13, color: MBGColors.neutral500),
                  ),
                  ...
                  if (authState.errorMessage != null) ...[
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.error_outline, size: 18, color: MBGColors.error),
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 13,
                                color: isDark ? MBGColors.error : Colors.red.shade700,
                              ),
                            ),
                          ),
                        ],
